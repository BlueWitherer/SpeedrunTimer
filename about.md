...
### Timer
A timer will appear on the top-right corner of the screen. It can be started and stopped via the `NumPad 1` key, and can be fully reset with `NumPad 3`. You can customize the keybinds via the *[Custom Keybinds](mod:geode.custom-keybinds)* mod. When playing on mobile, you'll likely see buttons on the other side of the screen that do these exact things.
